...
class Pricing extends React.Component {
  ...
  render() {
    return (
      <Container className={`${classes.container} ${classes.pricing}`}>
        <header
        ...
        <main>
          <Fade>
            <div className={classes.hero}>
              ...
              <h1 className={classes.hero__heading}>Plans & Pricing</h1>
          
            </div>
          </Fade>
          <section className={classes.subscriptions}>
            <h2 className={classes.subscriptions__heading}>Our current plans</h2>
