...
import "../../../assets/css/InsightsIQ/faq.scss";
...
class UIUXDesign extends Component {
  ...
  render() {
    return (
      <Container className={`${classes.container} ${classes["use-case"]}`}>
        <header
        ...
        <main>
          <Fade>
            <div className={classes.hero}>
              ...
              <section className={classes.uiux}>
                <img src={UIUX} alt="" />
                <div>
          ...
          <section className={classes.features}>
            <Fade>
              <article className={`${classes["concept-testing"]}`}>
                <h3>Concept testing:</h3>
                <p>
                  Concept testing involves presenting users with a description
                  or mockup of a proposed product and gathering feedback on its
                  potential success. This method allows for early testing of
                  product ideas and can help identify potential issues before
                  development begins.Beta testing: Beta testing involves
                  releasing a product to a small group of users for testing.
                  This method allows for testing of a product's functionality
                  and usability before its official release.
                </p>
                <ol>
                  <li>
                    {" "}
                    User testing: User testing is a method of evaluating a
                    product by observing users as they interact with it. This
                    method can provide valuable insights into how a product is
                    used and identify any issues that need to be addressed.
                  </li>
                  <li>
                    Focus groups: Focus groups involve bringing together a small
                    group of users to discuss a product or its development. This
                    method allows for the gathering of feedback and ideas from a
                    diverse group of users.
                  </li>
                </ol>
              </article>
              <article
                className={`${classes["concept-testing"]} ${classes.feedbacks}`}
              >
                <h3>Customer feedback:</h3>
                <p>
                  Customers can provide valuable feedback on the product
                  development process by giving their opinions and suggestions
                  on how to improve the product. This can be done through
                  surveys, interviews, or other forms of customer feedback.
                </p>
              </article>
      
            </Fade>
          
            <div className={classes.features__lights}>
                <img src={Lights} alt="" />
              </div>
            <h2 className={classes.features__heading}>Features</h2>
            <Row className={classes.features__row}>
              <AttentionSeeker effect="animate__bounceInLeft">
                <figure
                  className={`${classes.features__feature} ${
                    this.state.features.hover === "1"
                      ? classes["features__feature--active"]
                      : null
                  }`}
                  onMouseEnter={() =>
                    this.setState((state) => ({
                ...
                >
                  <figcaption>
                    ...
                    >
                      <path
                        d="M7.99984 24C10.9454 24 13.3332 21.6122 13.3332 18.6667C13.3332 15.7212 10.9454 13.3334 7.99984 13.3334C5.05432 13.3334 2.6665 15.7212 2.6665 18.6667C2.6665 21.6122 5.05432 24 7.99984 24Z"
                        fill="#7F56D9"
                      />
                      <path
                        d="M55.9998 24C58.9454 24 61.3332 21.6122 61.3332 18.6667C61.3332 15.7212 58.9454 13.3334 55.9998 13.3334C53.0543 13.3334 50.6665 15.7212 50.6665 18.6667C50.6665 21.6122 53.0543 24 55.9998 24Z"
                        fill="#7F56D9"
                      />
                      <path
                        d="M19.9998 44V49.3333C19.9998 50.96 19.0132 52.3733 17.6265 52.96C17.1198 53.2 16.5865 53.3333 15.9998 53.3333H10.6665C8.45317 53.3333 6.6665 51.5467 6.6665 49.3333V44C6.6665 41.7867 8.45317 40 10.6665 40H15.9998C18.2132 40 19.9998 41.7867 19.9998 44Z"
                        fill="#7F56D9"
                      />
                      <path
                      ...
                      />
                      <path
                        d="M40 14.6666V22.6666C40 24.8533 38.1867 26.6666 36 26.6666H28C25.8133 26.6666 24 24.8533 24 22.6666V14.6666C24 12.48 25.8133 10.6666 28 10.6666H36C38.1867 10.6666 40 12.48 40 14.6666Z"
                        fill="#7F56D9"
                      />
                      <g opacity="0.4">
                        <path
                          opacity="0.4"
                          d="M24.0002 16.6666H13.3335C12.2402 16.6666 11.3335 17.5733 11.3335 18.6666C11.3335 19.76 12.2402 20.6666 13.3335 20.6666H20.1868C14.7202 24.72 11.3335 31.44 11.3335 38.6666C11.3335 39.2 11.3602 39.7067 11.4402 40.24C11.5468 41.2534 12.4268 42 13.4135 42C13.4935 42 13.5735 42 13.6535 42C14.7468 41.8666 15.5468 40.8799 15.4135 39.7866C15.3602 39.4132 15.3602 39.0667 15.3602 38.6933C15.3602 31.76 19.1202 25.3599 24.9335 22.4266C25.9202 21.9199 26.3202 20.72 25.8135 19.7334C25.7868 19.7067 25.7602 19.6799 25.7602 19.6533C25.9202 19.3599 26.0535 19.04 26.0535 18.6933C26.0002 17.5733 25.0935 16.6666 24.0002 16.6666Z"
                          fill="#7F56D9"
                        />
                        <path
                          opacity="0.4"
                          d="M43.8133 20.6666H50.6667C51.76 20.6666 52.6667 19.76 52.6667 18.6666C52.6667 17.5733 51.76 16.6666 50.6667 16.6666H40C38.9067 16.6666 38 17.5733 38 18.6666C38 19.0133 38.1067 19.3333 38.2933 19.6266C38.2667 19.6533 38.24 19.68 38.24 19.7067C37.7333 20.6933 38.1333 21.8934 39.12 22.4C44.9333 25.3334 48.6933 31.7333 48.6933 38.6666C48.6933 39.04 48.6667 39.3866 48.64 39.7599C48.5067 40.8532 49.3067 41.8399 50.4 41.9733C50.48 41.9733 50.56 41.9733 50.64 41.9733C51.6533 41.9733 52.5067 41.2267 52.6133 40.2133C52.6667 39.68 52.72 39.1733 52.72 38.6399C52.6667 31.4399 49.28 24.72 43.8133 20.6666Z"
                          fill="#7F56D9"
                        />
                      </g>
                    </svg>
                    <h5>
                      User-centric design prepared by the usability testing
                      surveys in a couple of hours
                    </h5>
                    Navigate the design and satisfy user needs by using Insights
                    IQ's usability testing surveys
                  </figcaption>
                </figure>
              </AttentionSeeker>
              <AttentionSeeker effect="animate__bounceInRight">
                <figure
                  className={`${classes.features__feature} ${
                    this.state.features.hover === "2"
                      ? classes["features__feature--active"]
                      : null
                  }`}
                  onMouseEnter={() =>
                ...
                >
                  ...
                  <figcaption>
                    ...
                    >
                      <path
                        d="M7.99984 23.9999C10.9454 23.9999 13.3332 21.6121 13.3332 18.6666C13.3332 15.7211 10.9454 13.3333 7.99984 13.3333C5.05432 13.3333 2.6665 15.7211 2.6665 18.6666C2.6665 21.6121 5.05432 23.9999 7.99984 23.9999Z"
                        fill="#039855"
                      />
                      <path
                        d="M55.9998 23.9999C58.9454 23.9999 61.3332 21.6121 61.3332 18.6666C61.3332 15.7211 58.9454 13.3333 55.9998 13.3333C53.0543 13.3333 50.6665 15.7211 50.6665 18.6666C50.6665 21.6121 53.0543 23.9999 55.9998 23.9999Z"
                        fill="#039855"
                      />
                      <path
                        d="M19.9998 44V49.3333C19.9998 50.96 19.0132 52.3733 17.6265 52.96C17.1198 53.2 16.5865 53.3333 15.9998 53.3333H10.6665C8.45317 53.3333 6.6665 51.5467 6.6665 49.3333V44C6.6665 41.7867 8.45317 40 10.6665 40H15.9998C18.2132 40 19.9998 41.7867 19.9998 44Z"
                      ...
                      />
                      <path
                        d="M40 14.6667V22.6667C40 24.8534 38.1867 26.6667 36 26.6667H28C25.8133 26.6667 24 24.8534 24 22.6667V14.6667C24 12.4801 25.8133 10.6667 28 10.6667H36C38.1867 10.6667 40 12.4801 40 14.6667Z"
                        fill="#039855"
                      />
                      <g opacity="0.4">
                        <path
                          opacity="0.4"
                          d="M24.0002 16.6667H13.3335C12.2402 16.6667 11.3335 17.5734 11.3335 18.6667C11.3335 19.7601 12.2402 20.6667 13.3335 20.6667H20.1868C14.7202 24.7201 11.3335 31.4401 11.3335 38.6667C11.3335 39.2001 11.3602 39.7068 11.4402 40.2402C11.5468 41.2535 12.4268 42.0001 13.4135 42.0001C13.4935 42.0001 13.5735 42.0001 13.6535 42.0001C14.7468 41.8667 15.5468 40.88 15.4135 39.7867C15.3602 39.4134 15.3602 39.0668 15.3602 38.6934C15.3602 31.7601 19.1202 25.36 24.9335 22.4267C25.9202 21.92 26.3202 20.7201 25.8135 19.7335C25.7868 19.7068 25.7602 19.6801 25.7602 19.6534C25.9202 19.3601 26.0535 19.0401 26.0535 18.6934C26.0002 17.5734 25.0935 16.6667 24.0002 16.6667Z"
                          fill="#039855"
                        />
                        <path
                          opacity="0.4"
                          d="M43.8133 20.6667H50.6667C51.76 20.6667 52.6667 19.7601 52.6667 18.6667C52.6667 17.5734 51.76 16.6667 50.6667 16.6667H40C38.9067 16.6667 38 17.5734 38 18.6667C38 19.0134 38.1067 19.3334 38.2933 19.6267C38.2667 19.6534 38.24 19.6801 38.24 19.7068C37.7333 20.6935 38.1333 21.8935 39.12 22.4001C44.9333 25.3335 48.6933 31.7334 48.6933 38.6667C48.6933 39.0401 48.6667 39.3867 48.64 39.76C48.5067 40.8533 49.3067 41.8401 50.4 41.9734C50.48 41.9734 50.56 41.9734 50.64 41.9734C51.6533 41.9734 52.5067 41.2268 52.6133 40.2135C52.6667 39.6801 52.72 39.1734 52.72 38.6401C52.6667 31.4401 49.28 24.7201 43.8133 20.6667Z"
                          fill="#039855"
                        />
                      </g>
                    </svg>
                    <h5>Create Design+ Data Collaboration</h5>
                    Enhance UX design with using data collected from surveys
                  </figcaption>
                </figure>
              </AttentionSeeker>
            </Row>
              ...
              <AttentionSeeker effect="animate__bounceInLeft">
                ...
                >
                  <figcaption>
                    ...
                    <h5>
                      Get quantitative feedback for qualitative design decisions
                      with online surveys.{" "}
                    </h5>
                    Make user experience as smooth as possible by using survey's
                    quantitative data to make informed design decisions
                  </figcaption>
                </figure>
              </AttentionSeeker>
              <AttentionSeeker effect="animate__bounceInRight">
                ...
                >
                  <figcaption>
                    ...
                    <h5>
                      Find out how your design stands out from the competitors
                    </h5>
                    Insights IQ's surveys are also focused on providing insight
                    into how your product compares to its competitors. With this
                    specific information, designers can identify areas where
                    their product can differentiate itself in the market.
                  </figcaption>
                </figure>
              </AttentionSeeker>
            </Row>
          ...
          <Fade>
            <section className={classes.reasons}>
              <h2 className={classes.reasons__heading}>
                Why Insight IQ for UX Design
              </h2>
              <div className={classes.reasons__lights}>
                <img src={Lights} alt="" />
              </div>
              <Row className={classes.reasons__row}>
                <div className={classes.reasons__reason}>
                  <h5>
                    Get quantitative feedback for qualitative design decisions
                    with online surveys.
                  </h5>
                ...
                <div className={classes.reasons__reason}>
                  <h5>Create Design+ Data Collaboration .</h5>
                  <p>
                    Thank to our setting capabilities, InsightsIQ can be easily
                    used for accurate marketing research.
                  </p>
                </div>
                <div className={classes.reasons__reason}>
                  ...
                  <p>
                    ...
                    smooth. Brand IQ team can help you with creating surveys for
                    foreign respondents and get comprehensive data, before
                    launching your product there.
                  </p>
                </div>
              </Row>
            </section>
